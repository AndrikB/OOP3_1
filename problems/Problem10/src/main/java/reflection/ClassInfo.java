...
public class ClassInfo
{
    ...
    public static String printInfo(String name) throws ClassNotFoundException {
        StringBuilder builder = new StringBuilder();

        Class cl = Class.forName(name, false,
                new Loader(new String[]{"G:\\OOP1\\problems\\Problem10\\build\\classes\\java\\main\\reflection"}));
